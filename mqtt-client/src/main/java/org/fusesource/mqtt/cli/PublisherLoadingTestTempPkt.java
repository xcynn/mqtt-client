 ...
 */
public class PublisherLoadingTestTempPkt {
    ...
    public static void main(String[] args) throws Exception {
        PublisherLoadingTestTempPkt main = new PublisherLoadingTestTempPkt();
...
//                System.out.println("array="+body.toByteArray());
                ByteBuffer bf = ByteBuffer.wrap(body.toByteArray());
                bf.order(ByteOrder.LITTLE_ENDIAN);
                bf.putInt(0,bf.getInt(0)+1);
